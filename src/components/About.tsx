...
export default function About() {
  return (
    <div className='flex flex-col lg:flex-row items-center justify-center w-full max-w-[70rem] gap-20 px-10 relative'>
      <ProfileCard
        name=""
      ...
      <div className="flex flex-col justify-center items-center lg:items-start gap-10">
        <p className='text-white text-xl text-center lg:text-left'> I am an experienced Frontend Developer about 4 years of expertise in creating responsive and user
      ...
      <StarBorder
        ...
        color="#4D7DFE"
        speed="3s"
        href="/Ozlem_Engin_Sagir_Frontend_Developer_CV.pdf"
        download={true}
        thickness={3}
      >
      Download Resume
